...
if [ $psid -ne 0 ]; then  
	...
	#启动
	JAVA_OPTS="-server -Xms1024m -Xmx1024m -XX:MaxPermSize=256m -Djava.net.preferIPv4Stack=true"
	java $JAVA_OPTS -classpath $LIB_JARS $APP_MAINCLASS >  studo.log 2>&1 &
